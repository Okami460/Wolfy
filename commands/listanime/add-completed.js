...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (!query) return message.channel.send("Veuillez inclure un anime à ajouter!");
    ...
    data.completed.unshift(query);

    data.save();

    return message.channel.send(`Ajout de: ${query} to completed`);
  },
};